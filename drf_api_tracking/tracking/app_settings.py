...
class AppSettings:
    ...
    def _setting(self, name, default):
        ...
        return getattr(settings, self.prefix , default)  #mige boro tooye file settings self.prefix ro vaseye ma 
                                                         #bekhoon age ham nabodesh vasamoon meghdare defaulto bargardon.
   
    #hala maghadrire default ro moshakhas mikonim:
    @property
    def PATH_LENGTH(self):   
        return self._setting('PATH_LENGTH' , 200)    #boro toye _setting() meghdare 'PATH_LENGTH' ro bekhoon ag                                          #hamchin mghdari nabood 200 ro b argardoon.
